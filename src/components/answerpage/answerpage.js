...
import {Button, Row, ButtonGroup, Col, Input, Spinner, Badge,
    ...
    renderRequest = () => {
        return (
            <div>
                ...
                <Row>
                    <Input type="textarea" value={this.state.comment} onChange={(e)=>this.onCommentChange(e)} placeholder="Any comment?" id="comment" />
                </Row>
                <Row>
                    <ButtonGroup id="btn">
                        <Col>
                            <Button onClick={()=>this.changeRequestStatus("approved", this.state.request.requestId)} id="approvebtn">Approve</Button>
                        </Col>
                        <Col>
                            <Button onClick={()=>this.changeRequestStatus("denied", this.state.request.requestId)} id="denybtn">Deny</Button>
                        </Col>
                    </ButtonGroup>
                </Row>
            </div>
